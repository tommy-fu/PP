  ...
  methods: {
    validateEmail: function validateEmail() {
      ...
      axios.post("/newsletter", {
        ...
        _this.emailFail = response.data.emailFail;
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.page-title[data-v-fa6affac] {\n  background: gray;\n  padding: 10px;\n  text-align: center;\n  width: 50%;\n  color: white;\n}\n.body-content[data-v-fa6affac] {\n  border: 1px solid;\n  width: 50%;\n  padding: 9px;\n  text-align: center;\n}\n", ""]);
// Exports
...
var render = function() {
  ...
  return _c("div", [
    _c("div", { staticClass: "input-body input-wrapper" }, [
      _c("input", {
        directives: [
          {
            name: "model",
        ...
        staticClass: "input body-md input-body",
        attrs: { id: "signup", name: "signup", placeholder: "Email Address" },
        domProps: { value: _vm.signup },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.signup = $event.target.value
          }
        }
      }),
      _vm._v(" "),
        ...
        "button",
        {
          ...
          on: {
            click: function($event) {
              return _vm.validateEmail(_vm.signup)
            }
          }
        },
        [_vm._v("\n      Sign up\n    ")]
    ...
    _vm._v(" "),
    _vm.emailFail
      ? _c("p", { staticClass: "is-centered", staticStyle: { color: "red" } }, [
