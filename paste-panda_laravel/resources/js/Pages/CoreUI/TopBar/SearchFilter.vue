<template>
    <Dropdown ref="sectionsDropdown">
        <template v-slot:button="props">
            <div class="outlined-btn mr-12" role="button" style="user-select: none;">
        ...
        <div style="align-items: center; justify-content: flex-end">
            <p class="color-a3a3a3" style="margin-right: 20px">Prod</p>
            <input type="checkbox" name="" id=""  style="margin-right: 10px" v-model="prod" @click="prod=!prod;filter();">
            <p class="color-a3a3a3" style="margin-right: 20px">Draft</p>
            <input type="checkbox" name="" id="" style="margin-right: 10px" v-model="draft" @click="draft=!draft;filter();">
            <p class="color-a3a3a3" style="margin-right: 20px">Model</p>
            <input type="checkbox" name="" id="" style="margin-right: 10px" v-model="model" @click="model=!model;filter();">
        </div>
    </Dropdown>
</template>
