<template>
    <div>
        <div class="menu-item"
             ...
             :class="{
                   'menu-item--active': isActive(item[objectKey]),
                    }"
             @click="setUrl(item[objectKey])"
             :key="item[objectKey]"
        >
            <div class="count-container">
                <div class="body-sm" :class="activeColor">
                    <slot name="count" :item="item"></slot>
                </div>
            </div>
            <div class="body-md" :class="activeColor">
...
export default {
    ...
    computed: {
        activeColor() {
            return this.active ? 'color-a3a3a3' : 'color-636363';
        },
    },
    methods: {
        setUrl(slug) {
