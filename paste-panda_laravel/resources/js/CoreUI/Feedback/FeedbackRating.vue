<template>
		<div>
			...
			<div class="body-lg color-a3a3a3 mb-12">Pick a number</div>
			<div class="numbers-row-container mb-12">
				<a href="#" class="btn-outlined btn-outlined--square" v-for="index in 5"
				   style="max-width: 100%;"
				   :class="{'btn-outlined--primary' : internalValue.answer === (index)}"
				   @click="internalValue.answer = index">
					<div class="body-lg">{{index}}</div>
				</a>
			</div>
			
			<div class="numbers-row-container">
				<a href="#" class="btn-outlined btn-outlined--square"
				   :class="{'btn-outlined--primary' : internalValue.answer === (index + 5)}" v-for="index in 5"
				   @click="internalValue.answer = (index + 5)">
					<div class="body-lg">{{index + 5}}</div>
				</a>
			</div>
			<!--			<div style="display: flex; flex-wrap: wrap;">-->
			<!--				<div v-for="index in 10"-->
			<!--				     style="width: 20%; height: 48px; color: #FFF; background: #2d2d2d; display: flex; align-items: center; justify-content: center; border-radius: 8px; margin: 4px;" @click="internalValue.answer = index">-->
			<!--					{{index}}-->
			<!--				</div>-->
			<!--			</div>-->
		</div>
