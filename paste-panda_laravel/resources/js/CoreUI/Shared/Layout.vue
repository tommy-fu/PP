    ...
    <div>
        <div class="main" style="height: 100vh; overflow: hidden;">
            ...
            <div class="sidebar" style="">
                ...
                <div
                    style="width: 100%; background: rgb(38, 38, 38); padding-bottom: 80px;">
                    <slot></slot>
...
export default {
    ...
    methods: {
        ...mapMutations(['setCategories', 'setActiveCategory', 'setActiveCategory', 'setBrands', 'setActiveBrandId', 'setColorThemes', 'setUser', 'setSections']),
