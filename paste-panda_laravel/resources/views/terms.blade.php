...
@section('content')
    <div id="section-212" class="section is-relative py-48 py-64-landscape py-96-desktop scheme-1268" style="background: #171717">

        <div class="container">
            <div class="content has-text-white">
                <h2 class="h2 mb-40 mb-48-tablet">Terms and Conditions</h2>
                <p class="body-md mb-32 mb-40-tablet">Welcome to Kitspring!</p>
                <p class="body-md mb-32 mb-40-tablet">These terms and conditions outline the rules and regulations for
                    the use of VTT Digital AB's
                    Website, located at https://kitspring.com.</p>
                <p class="body-md mb-32 mb-40-tablet">By accessing this website we assume you accept these terms and
                    conditions. Do not continue to
                    use Kitspring if you do not agree to take all of the terms and conditions stated on this
                    page. Our Terms and Conditions were created with the help of the <a
                            href="https://www.termsandconditionsgenerator.com">Terms And Conditions
                        Generator</a> and the <a
                            href="https://www.privacypolicyonline.com/terms-conditions-generator/">Free Terms &
                        Conditions Generator</a>.</p>
                <p class="body-md mb-32 mb-40-tablet">The following terminology applies to these Terms and Conditions,
                ...
                <h4 class="h4 mb-12">Cookies</h4>
                <p class="body-md mb-32 mb-40-tablet">We employ the use of cookies. By accessing Kitspring, you agreed
                    to use cookies in agreement
                    with the VTT Digital AB's Privacy Policy.</p>
                <p class="body-md mb-32 mb-40-tablet">Most interactive websites use cookies to let us retrieve the
                    ...
                    use cookies.</p>
                <h4 class="h4 mb-12">License</h4>
                <p class="body-md mb-32 mb-40-tablet">Unless otherwise stated, VTT Digital AB and/or its licensors own
                    the intellectual property
                    rights for all material on Kitspring. All intellectual property rights are reserved. You
                    may access this from Kitspring for your own personal use subjected to restrictions set in
                    these terms and conditions.</p>
                <p class="body-md mb-32 mb-40-tablet">You must not:</p>
                <ul style="color: #FFF;">
                    <li>Republish material from Kitspring</li>
                    <li>Sell, rent or sub-license material from Kitspring</li>
                    <li>Reproduce, duplicate or copy material from Kitspring</li>
                    <li>Redistribute content from Kitspring</li>
                </ul>
                <p class="body-md mb-32 mb-40-tablet">This Agreement shall begin on the date hereof.</p>
                <p class="body-md mb-32 mb-40-tablet">Parts of this website offer an opportunity for users to post and
                    exchange opinions and
                    information in certain areas of the website. VTT Digital AB does not filter, edit, publish
                    or review Comments prior to their presence on the website. Comments do not reflect the views
                    and opinions of VTT Digital AB,its agents and/or affiliates. Comments reflect the views and
                    opinions of the person who post their views and opinions. To the extent permitted by
                    applicable laws, VTT Digital AB shall not be liable for the Comments or for any liability,
                ...
                <p class="body-md mb-32 mb-40-tablet">VTT Digital AB reserves the right to monitor all Comments and to
                    remove any Comments which
                    can be considered inappropriate, offensive or causes breach of these Terms and
                    Conditions.</p>
                <p class="body-md mb-32 mb-40-tablet">You warrant and represent that:</p>
                <ul style="color: #FFF;">
                ...
                <p class="body-md mb-32 mb-40-tablet">You hereby grant VTT Digital AB a non-exclusive license to use,
                    reproduce, edit and authorize
                    others to use, reproduce and edit any of your Comments in any and all forms, formats or
                    media.</p>
                <h4 class="h4 mb-12">Hyperlinking to our Content</h4>
                <p class="body-md mb-32 mb-40-tablet">The following organizations may link to our Website without prior
                    written approval:</p>
                <ul style="color: #FFF;">
                ...
                <p class="body-md mb-32 mb-40-tablet">These organizations may link to our home page, to publications or
                    to other Website
                ...
                <p class="body-md mb-32 mb-40-tablet">We may consider and approve other link requests from the following
                    types of
                    organizations:</p>
                <ul style="color: #FFF;">
                ...
                <p class="body-md mb-32 mb-40-tablet">We will approve link requests from these organizations if we
                    decide that: (a) the link would
                    ...
                    visibility of the hyperlink compensates the absence of VTT Digital AB; and (d) the link is
                    in the context of general resource information.</p>
                <p class="body-md mb-32 mb-40-tablet">These organizations may link to our home page so long as the link:
                    (a) is not in any way
                    ...
                    site.</p>
                <p class="body-md mb-32 mb-40-tablet">If you are one of the organizations listed in paragraph 2 above
                    and are interested in linking
                    to our website, you must inform us by sending an e-mail to VTT Digital AB. Please include
                ...
                <p class="body-md mb-32 mb-40-tablet">Approved organizations may hyperlink to our Website as
                    follows:</p>
                <ul style="color: #FFF;">
                ...
                <p class="body-md mb-32 mb-40-tablet">No use of VTT Digital AB's logo or other artwork will be allowed
                    for linking absent a
                    trademark license agreement.</p>
                <h4 class="h4 mb-12">iFrames</h4>
                <p class="body-md mb-32 mb-40-tablet">Without prior approval and written permission, you may not create
                    frames around our Webpages
                    that alter in any way the visual presentation or appearance of our Website.</p>
                <h4 class="h4 mb-12">Content Liability</h4>
                <p class="body-md mb-32 mb-40-tablet">We shall not be hold responsible for any content that appears on
                    your Website. You agree to
                ...
                <h4 class="h4 mb-12">Your Privacy</h4>
                <p class="body-md mb-32 mb-40-tablet">Please read Privacy Policy</p>
                <h4 class="h4 mb-12">Reservation of Rights</h4>
                <p class="body-md mb-32 mb-40-tablet">We reserve the right to request that you remove all links or any
                    particular link to our
                    ...
                    and conditions.</p>
                <h4 class="h4 mb-12">Removal of links from our website</h4>
                <p class="body-md mb-32 mb-40-tablet">If you find any link on our Website that is offensive for any
                    reason, you are free to contact
                ...
                <p class="body-md mb-32 mb-40-tablet">We do not ensure that the information on this website is correct,
                    we do not warrant its
                ...
                <h4 class="h4 mb-12">Disclaimer</h4>
                <p class="body-md mb-32 mb-40-tablet">To the maximum extent permitted by applicable law, we exclude all
                ...
                <p class="body-md mb-32 mb-40-tablet">The limitations and prohibitions of liability set in this Section
                ...
                <p class="body-md mb-32 mb-40-tablet">As long as the website and the information and services on the
                    website are provided free of
