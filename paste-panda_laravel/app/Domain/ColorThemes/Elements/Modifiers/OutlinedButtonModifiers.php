...
class OutlinedButtonModifiers implements ModifierInterface
{
    ...
    public static function handle($colorVariable = null): AbstractCssStyle
    {
        ...
        $builder = ButtonOutlined::getMasterBuilder('is-outlined', 'button_outlined', 'button_outlined');
...
//
//        $modifierCssStyle = CssStyle::make('is-outlined')
